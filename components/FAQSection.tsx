...
const faqs = [
  ...
  {
    q: 'สั่งซื้อได้ที่ไหน? มีรับประกันไหม?',
    a: 'ติดต่อสั่งซื้อโดยตรงกับ Biofeedback Thailand Official ซึ่งเป็นตัวแทนจำหน่ายอย่างเป็นทางการในประเทศไทย สินค้ารับประกัน 1 ปี นับจากวันที่ซื้อ ติดต่อคุณธาริน อุเทนรัตน์ ทางอีเมล u.tharin@gmail.com หรือโทร 089-444-3424 มีบริการให้คำปรึกษาและดูแลหลังการขายตลอด',
  },
  {
