...
const faqs = [
  ...
  {
    q: 'ต้องเตรียมตัวอย่างไรก่อนวัด?',
    a: 'เพื่อให้ผลแม่นยำที่สุด ควรปฏิบัติดังนี้: (1) นั่งพักนิ่งๆ อย่างน้อย 5 นาทีก่อนวัด (2) งดอาหารก่อนตรวจ 2 ชั่วโมง เพราะระบบย่อยอาหารอาจทำให้ค่า Sympathetic สูงผิดปกติ (3) งดกาแฟ บุหรี่ และยา ก่อนตรวจ 12 ชั่วโมง (4) อยู่ในสภาพแวดล้อมที่เงียบสงบ อุณหภูมิสบาย ไม่มีเสียงรบกวน (5) ระหว่างวัดให้มองไปที่ผนัง นั่งผ่อนคลาย หายใจปกติ',
  },
  {
    q: 'ราคาเท่าไหร่? สั่งซื้อได้ที่ไหน? มีรับประกันไหม?',
    a: 'สินค้ารับประกัน 1 ปี นับจากวันที่ซื้อ มีบริการให้คำปรึกษาและดูแลหลังการขายตลอด สำหรับราคาและโปรโมชั่นพิเศษ กรอกแบบฟอร์มด้านล่างได้เลย ทีมงานจะติดต่อกลับภายใน 24 ชั่วโมง รองรับทั้งการสั่งซื้อส่วนตัวและแบบองค์กร',
  },
];
